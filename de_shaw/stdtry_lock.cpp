...
// std::try_lock tries to lock MULTIPLE MUTEXES without blocking
// on success --> returns -1
// on success, must manually unlock
// on failure --> returns index of mutex that failed to lock
// on failure or exception, all mutexes are unlocked
